package com.yzy.system.security.verification;
...
import com.yzy.controller.BaseController;
...
public class CreateImageCode extends BaseController{
	private static final Logger log = LoggerFactory.getLogger(CreateImageCode.class);
    // 图片的宽度。
