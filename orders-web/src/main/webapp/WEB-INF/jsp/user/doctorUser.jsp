...
<div id="insertUserDiv" style="display: none;padding: 10px;" >
	<form class="layui-form " action="">
		    ...
		    <div class="layui-input-block">
		      <input type="radio" name="roleId" value="3" title="员工" checked>
      		  <input type="radio" name="roleId" value="2" title="负责人">
		    </div>
		  </div>
	  	  <div class="layui-form-item">
...
<script type="text/javascript" src="static/js/page-js/user/doctorUser.js?v=<%=version %>"></script>
</body>