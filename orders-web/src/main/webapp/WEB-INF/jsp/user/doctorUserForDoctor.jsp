...
<div id="insertUserDiv" style="display: none;padding: 10px;" >
	<form class="layui-form " action="">
		  ...
		  <input type="hidden" name="unitId" value="${sessionScope.loginInfo.unitId }">
...
<div id="insertUnitDiv" style="display: none;padding: 10px;"" >
	<form class="layui-form" action="">
		<div class="layui-form-item">
	      <label class="layui-form-label">名称<span class="required-sign">☀</span></label>
	      <div class="layui-input-block">
	        <input type="text" name="unitName" lay-verify="required|zhName" placeholder="请输入单位名称" autocomplete="off" class="layui-input">
	      </div>
	    </div>
...
<script type="text/javascript" src="static/js/page-js/user/doctorUserForDoctor.js?v=<%=version %>"></script>
</body>