...
<div class="left-nav" >
	...
	<div class="user-photo" >
  	 	<a class="img" title="我的头像" onclick="sm.pageSkip('page/doctorPerson')">
	...
	<ul class="layui-nav layui-nav-tree layui-bg-cyan layui-inline" lay-filter="demo">
	  ...
	  <shiro:hasPermission name="doctor:user">
	  	<li onclick="sm.pageSkip('page/toDoctorUserForDoctor')" class="layui-nav-item"><a href="javascript:;">人员管理</a></li>
	  </shiro:hasPermission>
	</ul>
</div>
<!-- 右侧导航 -->
		...
		<ul class="layui-nav" >
		  <li class="layui-nav-item">
		    ...
		    <dl class="layui-nav-child">
		      <dd onclick="sm.pageSkip('page/doctorPerson')"><a href="javascript:void(0);">个人中心</a></dd>
...
<script type="text/javascript" src="static/js/page-js/main/doctorMain.js?v=<%=version %>"></script>
</body>